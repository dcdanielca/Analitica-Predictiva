...
def initialize_parameters(regularizer):
    """
...
def compute_cost(Z3, Y, regularizer):
    """
...
def model(X_train, Y_train, X_test, Y_test, learning_rate = 0.009, num_epochs = 500, minibatch_size = 16, print_cost = True):
    """
    ...
    parameters = initialize_parameters(regularizer)
