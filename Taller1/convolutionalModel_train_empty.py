...
# -*- coding: utf-8 -*-
"""
Created on Sat Jul  6 11:55:32 2019
...
X_train_orig, Y_train_orig, X_test_orig, Y_test_orig, classes = load_dataset_office()     # Cargar la base de datos
...
def model(X_train, Y_train, X_test, Y_test, learning_rate = 0.009, num_epochs = 450, minibatch_size = 16, print_cost = True):
    ...
    Y_train -- Etiquetas del conjunto de entrenamiento, de tamaño (None, n_y = 4)
    X_test -- Conjunto de datos de Test, de tamaño (None, 64, 64, 3)
    Y_test -- Etiquetas del conjunto de Test, de tamaño  (None, n_y = 4)
